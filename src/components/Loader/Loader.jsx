...
const Loader = ({ forSusp }) => {
    return (
        <div className={forSusp && s.loader}>
            <StyledWrapper>
                <div className="loader" id={forSusp && s.loaderId}>
                    <svg xmlSpace="preserve" viewBox="0 0 254.532 254.532" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" className="wheel">
                        <g>
                            <path
